...
struct ZoneConnectionClass
{
    ...
    {
        return (FromMapCoords == other.FromMapCoords && ToMapCoords == other.ToMapCoords && unknown_bool_08 == other.unknown_bool_08 && Cell == other.Cell);
    }
};
...
struct SubzoneConnectionStruct
{
    ...
    {
        return (unknown_dword_0 == other.unknown_dword_0 && unknown_byte_4 == other.unknown_byte_4);
    }
};
...
public:
    ...
    {
        return (unknown_word_18 != other.unknown_word_18 && unknown_dword_1C == other.unknown_dword_1C && unknown_dword_20 == other.unknown_dword_20);
    }
};
...
public:
    ...
    {
        return (lyr >= Layer::Underground && lyr <= Layer::Top) ? &ObjectsInLayers[static_cast<int>(lyr)] : nullptr;
    }
    ...
    */
    ...
    static void __fastcall FlashbangWarheadAt(int Damage, WarheadTypeClass *WH, CoordStruct coords, bool Force = 0, SpotlightFlags CLDisableFlags = SpotlightFlags::None)
    {
        JMP_STD(0x48A620);
    }
    ...
    CellStruct *PickCellOnEdge(CellStruct &buffer, Edge Edge, const CellStruct &CurrentLocation, const CellStruct &Fallback, SpeedType SpeedType, bool ValidateReachability, MovementZone MovZone) const
    {
        JMP_THIS(0x4AA440);
    }

    CellStruct PickCellOnEdge(Edge Edge, const CellStruct &CurrentLocation, const CellStruct &Fallback, SpeedType SpeedType, bool ValidateReachability, MovementZone MovZone) const
    {
        CellStruct buffer;
